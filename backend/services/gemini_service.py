...
class GeminiService:
    def __init__(self):
        ...
        try:
            ...
            print(f"❌ Failed to list Gemini models: {e}. Defaulting to gemini-1.5-flash.")
    ...
    async def chat_query(self, question: str, context: dict) -> str:
        ...
        try:
            ...
            quota_indicators = ["429", "quota", "limit", "rate_limit", "exhausted", "free_tier"]
    ...
    def _get_heuristic_answer(self, question: str, context: dict) -> str:
        ...
        if any(greet in q for greet in ["hi", "hello", "hey", "who are you", "what is your name"]):
            return (
